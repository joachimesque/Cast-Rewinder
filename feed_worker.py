...
def import_feed(url, ignore_date = False, ignore_conditional_loading = False):
  ...
  if bool(u.scheme):
    ...
    elif response_content_type in ('text/xml','application/rss+xml','application/atom+xml','application/xml+rss','application/xml+atom','application/xml','application/xhtml+xml','application/xml+xhtml',''):
